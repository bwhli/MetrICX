...
export class SettingsPage {
  ...
  async ionViewWillEnter()  {
    ...
    this.settingsForm.patchValue({address: settings.addresses._0.address});
  ...
  async save() {
    var settings = await this.settingsService.get();
    settings.addresses._0.address = this.settingsForm.controls['address'].value; //This would need refactoring with new UI
